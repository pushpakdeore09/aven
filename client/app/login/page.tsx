  ...
  return (
    <div className="relative flex min-h-svh flex-col overflow-hidden bg-background">
      <div className="pointer-events-none absolute inset-0 bg[radial-gradient(ellipse_at_top,oklch(from_var(--primary)_l_c_h/0.1),transparent_55%)]">
        <header className="pointer-events-auto relative z-10 flex h-14 items-center justify-between px-4">
          <Link href="/">
            <BrandMark />
          </Link>
          <ModeToggle />
        ...
        <main className="pointer-events-auto relative z-10 flex flex-1 items-center justify-center px-4 py-10">
